...
\begin{frame}<6>{Real-worl social autonomy: cognitive architectures}
    ...
    \begin{center}
     ...
     \begin{columns}
        ...
        \resizebox{\columnwidth}{!}{%
            ...
            {\scriptsize
            \begin{itemize}
                \item full socio-cognitive architecture for autonomy
...
\begin{frame}{}
        ...
        \begin{tikzpicture}
            \node[rotate=90,text width=2.5cm]{\small\textbf{Understanding\\interaction}};
        \end{tikzpicture}
...
\begin{frame}{Social robotics}
    ...
    \begin{columns}
        \begin{column}{0.7\linewidth}
            ...
            \begin{itemize}
                \item designing and implementing the companion and assistant
                    robots of tomorrow
                \item major societal challenge for the next 10 years; European priority
            \end{itemize}

    \setbeamercolor{hriSec1Demo}{bg=hriSec1,fg=white}
    \begin{beamercolorbox}[wd=\linewidth,ht=9ex,dp=0.7ex]{hriSec1Demo}
        \large \bf \centering
    ...
    \vspace{2em}
    Understand the dynamics of long-term social human-robot interactions;

    Create and sustain responsible, real-world autonomous interactions with robots
...
\begin{frame}[plain]
    \includegraphics[width=\linewidth]{architectures/archi.pdf}

    \scriptsize
    \textbf{Main challenge}: \textbf{arbitration} between \textbf{intrinsic
    social motivation}
            (teleologic architecture), \textbf{bottom-up human policies}
            (human-in-the-loop machine learning), and \textbf{top-down human-aware task
            planning}.

        New research question! one lead: \textbf{experience transfer in RL}
\end{frame}
...
\begin{frame}{Integration LAAS}
    ...
    \begin{itemize}
        ...
        \item Emerging theme: Data-driven social AI
