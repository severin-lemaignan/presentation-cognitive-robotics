...
\begin{frame}{My research project}
    ...
    \begin{beamercolorbox}[wd=\linewidth,ht=9.5ex,dp=0.7ex]{hriSec1Demo}
        \Large \bf \centering
...
\begin{frame}<1>[label=wps]{Research programme}
    \begin{center}
    \only<1>{
...
\begin{frame}[plain]
    ...
    social motivation}
        ...
        New research question! one lead: \textbf{experience transfer}.
\end{frame}
...
\begin{frame}{Integration LAAS}
    ...
    $\rightarrow$ natural integration to RIS team

    \begin{itemize}
        \item<1-> TBD
        \item<2-> Software engineering expertise almost unique in academia
        \item<3> TBD
    \end{itemize}
\end{frame}
