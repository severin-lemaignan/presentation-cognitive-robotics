    ...
    \begin{columns}
        \begin{column}{0.7\linewidth}
            ...
            \only<1>{
                ...
                \vspace{2em}
                Direct impact on ageing society, education, customer service.
            ...
            \only<2>{
                ...
                \begin{center}
                {\large \bf 
                Autonomous social robot: beyond state-of-the-art
                }
                \end{center}
                ...
                \begin{itemize}
                    ...
                    \item Closing the interaction loop;
