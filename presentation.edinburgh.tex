...
\begin{frame}[plain]
    ...
    \pause
    One example: the \emph{CoWriter} project
\end{frame}
}
...
\begin{frame}{My research plan}
    ...
    \begin{tikzpicture}[
        ...
        \node<1>[below=1 of bottom] (hyb) {hybridation};
...
\begin{frame}{Developing Child-Robot Interaction at Edinburgh}
    ...
    \begin{columns}
        ...
        \begin{column}{0.6\linewidth}
            ...
            \uncover<2>{
            Establish collaboration with the (new) \textbf{Royal Hospital for Sick
            Children}
            \begin{itemize}
...
\begin{frame}{Funding}
    ...
    \begin{itemize}
        \item {\bf EPSRC First Grant}
            \begin{itemize}
                ...
                \item covers equipment, but no PhD
    ...
    \begin{itemize}
        \item {\bf European (?) project coordination}
            \begin{itemize}
                \item Typically a EU \emph{Future and Emerging Technologies}
                    funding
            \end{itemize}
    \end{itemize}
    }
