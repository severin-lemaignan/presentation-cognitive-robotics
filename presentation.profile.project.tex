...
\section[Symbolic social cognition]{From Symbolic Social Cognition...}
...
\begin{frame}<6>{An architecture for social \& autonomous interaction}
    \begin{figure}
        \centering
...
\paper{Lemaignan et al. {\bf Artificial Cognition for Social Human-Robot
     Interaction: An Implementation} Artifical Intelligence, 2017}
\begin{frame}{An architecture for social \& autonomous interaction}
...
\imageframe[color=black]{couch25k/hri.jpg}
\imageframe[color=black]{couch25k/supervised.jpg}

{
    \paper{Winkle et al. \textbf{In-Situ Learning from a Domain Expert for Real World Socially Assistive Robot Deployment}
    RSS 2020}
    \fullbackground[scale=0.9]{couch25k/architecture.pdf}
\begin{frame}{}
\end{frame}
}
{
...
\section[Social kinematics]{Data-driven HRI: social kinematics}
...
\imageframe[color=black]{sparc/overview.jpg}
...
\begin{frame}{`human-in-the-loop' HRI}
    ...
    \begin{columns}
        ...
        \begin{column}{0.7\linewidth}
            ...
            \only<4>{
            \large $\rightarrow$ a shift from human-robot interactions to \emph{
...
\begin{frame}{Integration ISIR}
    ...
    \begin{itemize}
        ...
        \item<2-> robust perception: Catherine Achard
        \item<3> non-verbal communication: Catherine Pelachaud
    \end{itemize}
\end{frame}
