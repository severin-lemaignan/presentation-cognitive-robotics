...
%\maketitle
\imageframe{titlepage-ramon-llull}
...
\begin{frame}[plain]
        ...
        \begin{center}
                    ...
                    \begin{tikzpicture}[>=latex]
                        \node
                        {\includegraphics[width=0.3\linewidth]{teaching/robomaze}};
                        \node[fill=hriSec3!20,draw,rotate=-45] at (1,1)
                        {\tiny\it CS};
                    \end{tikzpicture}
            \pause
                    ...
                    \begin{tikzpicture}[>=latex]
                        \node
                        {\includegraphics[width=0.3\linewidth]{teaching/emotions}};
                        \node[fill=hriSec3!20,draw,rotate=-45] at (1,1)
                        {\tiny\it Machine learning};
                    \end{tikzpicture}
                    \begin{tikzpicture}[>=latex]
                        \node
                        {\includegraphics[width=0.3\linewidth]{teaching/mlp}};
                        \node[fill=hriSec3!20,draw,rotate=-45] at (1,1)
                        {\tiny\it Machine learning};
                    \end{tikzpicture}
%                    \begin{tikzpicture}[>=latex]
    ...
    \begin{columns}
        \begin{column}{0.7\linewidth}
            ...
            \only<1>{
                ...
                companion robots} for  tomorrow. Direct impact on ageing
                society, education, customer service.

                \vspace{2em}
                \textbf{Major socio-economic challenge} + \textbf{European
                priority} $\Rightarrow$ need to \textbf{develop capacity} and assert
                \textbf{leadership}
            }
...
\begin{frame}<1>[label=wps]{4 AXES TO SCAFFOLD AN AMBITIOUS RESEARCH GROUP}
    \begin{center}
    \only<1>{
