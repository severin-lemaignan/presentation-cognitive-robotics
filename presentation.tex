...
\date{Heriot-Watt University -- {\bf 16 May 2017}}
...

{
    \paper{Lemaignan et al., {\bf Artificial Cognition for Social Human-Robot
    Interaction: An Implementation}, Artifical Intelligence, 2016}
\begin{frame}<6>[label=archi]{Into an control architecture}
    \begin{figure}
        \centering
...

{
 ...
 \begin{frame}{Cellulo: design principles}
     ...
     \begin{itemize}
         \item {\bf ubiquitous}
             \note[item]{ubiquitous: a pervasive yet unremarkable tool
         ...
         \item {\bf versatile}
             \note[item]{versatile: applicable to a broad range of learning
         ...
         \item {\bf practical}
             \note[item]{practical: to gain field
