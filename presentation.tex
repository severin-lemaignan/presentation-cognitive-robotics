...
\section{The Robot's (Symbolic) World}
...
{
    \paper{Warnier, Guitton, Lemaignan, Alami {\Medium When the Robot Puts Itself in Your Shoes} -- ROMAN 2012}
    \begin{frame}{The False-Belief Experiment}
        \centering
...
\imageframe[caption=Next step: the representation-level]{zoo}
...
\begin{frame}{Cognitive Engagement and Meta-cognition}
    \video{0.55\textwidth}{videos/cowriter-session1_3minExcerpt_1x.mp4?autostart}
...
\begin{frame}{}
    \begin{center}
        \includegraphics[width=0.43\linewidth]{lettre-base}
        \uncover<2>{
        \hspace{1cm}%
        \includegraphics[width=0.43\linewidth]{lettre-final}
    }
    \end{center}
        \badge{europe_epfl}
\end{frame}
...
\begin{figure}
    \hspace*{5cm}\includegraphics[width=0.6\linewidth]{ranger-interactions-vs-qualitative-score}
\end{figure}
        \badge{europe_epfl}
\end{frame}
}
...
\begin{frame}{}
    ...
    \begin{center}
        Can we make the assessment of engagement {\Medium practical}?
    ...
    \centering
        \resizebox{!}{0.6\paperheight}{%
            ...
            child[concept color=hriSec2,text=black, grow=120] { node[concept] (action) {Performing with humans} 
                ...
                \node[circle, draw=red, very thick, minimum size=1.6cm] at (soc-ctxt.center) {};
...
\imageframe[caption=This is still somewhat unsatisfactory...]{pr2-baby-4.jpg}

\begin{frame}{}

    \centering
    {\Medium Let's play a game!}
\end{frame}
...
\begin{frame}{Attention, Awareness, Alignment}
    ...
    \columnbreak
        \uncover<2>{
                    \vspace*{1.5cm}
                    Attention is more about {\Medium representation} than visual perspective
                    \vspace{0.7cm}

            ``Awareness is a construct that represents the attentional state of a brain''

                    \scriptsize[Graziano {\Medium Consciousness and the Social Brain} -- 2013]
                }
    \end{multicols}
\end{frame}
...
\begin{frame}{Associative Memory}
    ...
    \centering
        \resizebox{0.8\linewidth}{!}{%
            ...
            \uncover<2>{
                \node[above=0.3 of i21,anchor=east]{Bert};
                \node[above=0.3 of i22,anchor=east]{Tony};
                \node[above=0.3 of i23,anchor=east]{Chris};

                \node[right=0.3 of i11]{Green cube in focus};
                \node[right=0.3 of i12]{Red cube in focus};
                \node[right=0.3 of i13]{Board in focus};

                \node[below=0.3 of i31,anchor=east]{Slow Motion};
                \node[below=0.3 of i32,anchor=east]{Avg. Motion};
                \node[below=0.3 of i33,anchor=east]{Fast Motion};
...
{
\fullbackground{hri2017-page}
\begin{frame}[plain]{}


    {\Medium Four main themes: studies, technical developments, theories and methods, design}

    {\Medium Deadline: Septembre 5}

    {\Medium Most selective conference of the field!}

    {\Medium Unconvential research/methodologies: alt.HRI!}
...
{
\paper{Dillenbourg, Lemaignan et al., {\Medium The Symmetry of Partner Modelling}, Intl. J. of Computer Supported Collaborative Learning 2016}
...
\section[CogArch]{Cognitive Architectures}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{LAAS Cognitive Architecture}
{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section[Dialogue]{Dialogue Grounding}

{
\paper{Lemaignan et al. {\Medium Grounding the Interaction: Anchoring
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section[Planning]{Human-aware Planning}
...
\section[Acting]{Performing in Human Environments}
