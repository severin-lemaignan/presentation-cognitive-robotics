...
\date{Bristol Robotics Lab -- {\bf May 11, 2016}}
...
{
    \paper{Lemaignan et al. {\bf Grounding the Interaction: Anchoring Situated Discourse in Everyday HRI} -- Intl. J. of Social Robotics 2011}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \subsection{Interaction spectrum}
...
%% TODO: add a slide on speech reco at Plym
...
{
    \paper{Baxter et al. {\bf Cognitive Architecture for HRI: Towards Behavioural Alignment} -- 2013}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Role of Unexpected Behaviours}
