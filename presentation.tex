...
{
\paper{Lemaignan, Dillenbourg {\Medium Mutual Modelling in Robotics: Inspirations for the Next Steps} -- HRI 2015}
...
\begin{frame}{CoWriter: cognitive engagement and meta-cognition}
    ...
    \begin{flushright}
        \includegraphics[width=0.55\textwidth]{diego-writing}
    \end{flushright}
...
{
\paper{Baxter, Lemaignan, Trafton {\Medium Cognitive Architectures for Social Human-Robot Interaction} -- HRI 2016}
