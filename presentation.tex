...
\subtitle{walking the path to artificial social cognition in HRI}
\date{IST Lisbon -- {\bf 26 May 2017}}
...

{
    ...
    \begin{frame}[plain]
            \begin{tikzpicture}[>=latex, remember picture, overlay,
                ...
                {\footnotesize Post-doc at Plymouth University
                \vspace{1em}
...
\section{What next on our agenda?}
...
\begin{frame}{}
    ...
    \Large
    \bf To push the boundaries of social robotics, we need to stress our robots

    \end{center}

    \begin{itemize}
        \item unpredictable situations
...
\begin{frame}{Key Milestones for HRI}
    ...
    \begin{itemize}
        ...
        \item {\bf generation of   'natural' (\ie emergent) turn-taking}
...
%            awareness 
        ...
        \item {\bf replication of \hyperlink{parten}{Parten's stages of
            play}}
...
\imageframe[color=black]{freeplay/zoo-activity2}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\imageframe[color=black]{freeplay/zoo-activity}
